			...
			if(userComment.trim() != ""){
				...
				$.ajax({
					...
					success: function(data){
						thisObj.closest(".comment-block").find(".comment-replies-block").append('<div class="comment-block clearfix"><div class="comment-image"><a href="/Content/#"><img class="list-thumbnail" src="' + userPic + '" width="40" height="40" /></a></div><div class="comment-title h4"><a href="/Content/#">' + userFullName + '</a> <small>Just Now</small></div><div class="comment-content">' + userComment + ' </div><div class="comment-controls"><div class="comment-controls-left"><a class="comment-reply-comment" href="/Content/#" title="Reply"><span class="icon icon-arrow-curve-left icon-size-medium"></span></a><a class="comment-repost" href="/Content/#" title="Re-Post This"><span class="icon icon-retweet icon-size-medium"></span></a></div></div></div>');
